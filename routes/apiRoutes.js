...
module.exports = function(app) {
  app.get("/search", function(req, res) {
      ...
      function getZillowData(parms, address) {
        return zApi
          ...
          .then(function(results) {
            ...
            var estVal =
              results.response.results.result[0].zestimate[0].amount[0]._;
            console.log(estVal);
    ...
    searchProperties(postalCode, minTaxAmt, maxTaxAmt, minMktTtlValue, maxMktTtlValue, maxBeds, maxBathsTotal)
      });
};
